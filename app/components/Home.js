      ...
      {!open ? (
        <div className="flex flex-col m-5 gap-5 ">
          <div className="text-center ">
            <p className="text-lg font-semibold">Felix Brad</p>
            <p className="text-xs text-gray-400">Payment form $FelixBrad329</p>
          </div>
          <div className="text-center mt-[50%]">
            <p className="text-2xl font-semibold">$180.00</p>
        ...
        <div className="w-full md:w-[40%] p-5 shadow-2xl rounded-md mx-auto">
          ...
          <p className="text-center text-sm text-gray-400">
            You just got <span className="text-green-500">$180</span> from Felix 
            Brad
